...
- 👁️ **Мокирование представлений** — Подменяйте VIEW-зависимости в тестируемой процедуре
- 🧱 **Фейкование таблиц** — Создавайте временные копии таблиц с auto-generated CREATE TABLE
